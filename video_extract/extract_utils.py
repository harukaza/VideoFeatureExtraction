# copy from /projects/InternVideo/InternVideo2/multi_modality/demo/utils.py
import numpy as np
import cv2
import os
import io
...
def setup_internvideo2(config: dict):
    ...
    tokenizer = BertTokenizer.from_pretrained("/projects/bert-large-uncased", local_files_only=True)
