...
model = dict(
    ...
    text_encoder=dict(
        ...
        llama_path="/home/user/D/32T/lpj/video/projects/others_backbone/video-feature/chinese_alpaca_lora_7b",
        use_lora=True,
    ),
    temp=1 / 100.0,
    temp_min=1 / 100.0,
    ...
    tokenizer_path="/home/user/D/32T/lpj/video/projects/others_backbone/video-feature/chinese_alpaca_lora_7b",
    vision_ckpt_path="/home/user/D/32T/lpj/video/projects/others_backbone/video-feature/InternVideo2-Stage2_1B-224p-f4/InternVideo2-stage2_1b-224p-f4.pt",
    load_vision_ckpt_from_internvideo2_stage2=True,
    text_ckpt_path="/home/user/D/32T/lpj/video/projects/others_backbone/video-feature/internvl_c_13b_224px.pth",
)
