# copy from /projects/InternVideo/InternVideo2/multi_modality/demo/internvideo2_stage2_config.py
...
model = dict(
    ...
    vision_encoder=dict(
        ...
        pretrained='/home/user/D/32T/lpj/video/projects/others_backbone/video-feature/InternVideo2-Stage2_1B-224p-f4/InternVideo2-stage2_1b-224p-f4.pt',
        use_checkpoint=True,
        checkpoint_num=40,
